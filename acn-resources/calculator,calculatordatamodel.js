...
var CalculatorData = {
    Services: {
        ...
        "virtual-machines-suse-linux-enterprise-basic": {
            Name: "虚拟机 - Suse Linux Enterprise Basic",
            Types: [{
                Name: "基本",
                Features: [{
                    Name: "default",
        ...
        "virtual-machines-suse-linux-enterprise-server-for-sap-priority": {
            Name: "虚拟机 - Suse Linux Enterprise Server For Sap Priority",
            Types: [{
                Name: "基本",
                Features: [{
                    Name: "default",
            ...
            },
            {
                ...
                },
                {
                    ...
                    },
                    {
                        ...
                        Description: CalculatorConst.M64msSizeDesc,
                        PriceTier: PriceTierEnum.Fixed,
                        PricePerTier: "103.828"
                    },
                    {
                        Name: "M128ms",
                        Description: CalculatorConst.M128msSizeDesc,
                        PriceTier: PriceTierEnum.Fixed,
                        PricePerTier: "263.868"
                    },
                    {
                        Name: "M64s",
                        Description: CalculatorConst.M64sSizeDesc,
                ...
                Features: [{
                    ...
                    Sizes: [
                        ...
                        },
                        {
                            ...
                            Description: "8 个内核",
                            PriceTier: PriceTierEnum.Fixed,
                            PricePerTier: "16.0529"
                        },
                        {
                            Name: "vCore 16",
                            Description: "16 个内核",
                            PriceTier: PriceTierEnum.Fixed,
                            PricePerTier: "32.1058"
                        },
                        {
                            Name: "vCore 24",
                            Description: "24 个内核",
                            PriceTier: PriceTierEnum.Fixed,
                            PricePerTier: "48.1586"
                        },
                        {
                            Name: "vCore 32",
                            Description: "32 个内核",
                            PriceTier: PriceTierEnum.Fixed,
                            PricePerTier: "64.2115"
                        },
                        {
                            Name: "vCore 40",
                            Description: "40 个内核",
                            PriceTier: PriceTierEnum.Fixed,
                            PricePerTier: "80.2644"
                        },
                        {
                            Name: "vCore 80",
                            Description: "80 个内核",
                            PriceTier: PriceTierEnum.Fixed,
                            PricePerTier: "160.5288"
                        }]
                },{
                    Name: "混合优惠价格",
                    PricePeriod: PricePeriodEnum.Hourly,
                    ...
                    Sizes: [
                        ...
                        },
                        {
                            ...
                            Description: "8 个内核",
                            PriceTier: PriceTierEnum.Fixed,
                            PricePerTier: "10.9666"
                        },
                        {
                            Name: "vCore 16",
                            Description: "16 个内核",
                            PriceTier: PriceTierEnum.Fixed,
                            PricePerTier: "21.9332"
                        },
                        {
                            Name: "vCore 24",
                            Description: "24 个内核",
                            PriceTier: PriceTierEnum.Fixed,
                            PricePerTier: "32.8998"
                        },
                        {
                            Name: "vCore 32",
                            Description: "32 个内核",
                            PriceTier: PriceTierEnum.Fixed,
                            PricePerTier: "43.8665"
                        },
                        {
                            Name: "vCore 40",
                            Description: "40 个内核",
                            PriceTier: PriceTierEnum.Fixed,
                            PricePerTier: "54.8331"
                        },
                        {
                            Name: "vCore 80",
                            Description: "80 个内核",
                            PriceTier: PriceTierEnum.Fixed,
                            PricePerTier: "109.6662"
                        }]
                },
                {
                    Name: "存储",
            ...
            Types: [
                {
                    ...
                    Features: [{
                        ...
                        Sizes: [
                        {
                            ...
                            Description: "1 个内核",
                            PriceTier: PriceTierEnum.Fixed,
                            PricePerTier: "0.26988"
                        },
                        {
                            Name: "vCore 2",
                            Description: "2 个内核",
                            PriceTier: PriceTierEnum.Fixed,
                            PricePerTier: "0.53975"
                        }]
                    },
                    {
                        Name: "存储",
                ...
                Features: [{
                    ...
                    },
                    {
                        ...
                        Description: "32 个内核",
                        PriceTier: PriceTierEnum.Fixed,
                        PricePerTier: "10.6803"
                    },{
                        Name: "vCore 64",
                        Description: "64 个内核",
                        PriceTier: PriceTierEnum.Fixed,
                        PricePerTier: "21.3606"
                    }]
                },
                {
                    Name: "存储",
                ...
                Features: [{
                    ...
                    Sizes: [
                        ...
                        },
                        {
                            ...
                            Description: "16 个内核",
                            PriceTier: PriceTierEnum.Fixed,
                            PricePerTier: "14.9987"
                        },{
                            Name: "vCore 32",
                            Description: "32 个内核",
                            PriceTier: PriceTierEnum.Fixed,
                            PricePerTier: "29.9974"
                        }]
                },
                {
                    Name: "存储",
